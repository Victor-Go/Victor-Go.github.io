...
`
  ...
  ko: {
    ...
    margins: "여백",
    marginHorizontal: "좌우 여백",
    marginVertical: "상하 여백",
...
`
  ...
  ru: {
    ...
    margins: "Поля",
    marginHorizontal: "Горизонтальные поля",
    marginVertical: "Вертикальные поля",
...
`
  ...
  uk: {
    ...
    templateLabel: "Шаблон резюме",
    margins: "Поля",
    marginHorizontal: "Горизонтальні поля",
    marginVertical: "Вертикальні поля",
...
export const extraTranslations: Record<string, ExtraTranslations> = {
  en: {
    ...
    barrierTitle: "Screen Width Too Narrow",
    barrierDescription: "This builder requires a minimum screen width of 1125px to ensure side-by-side editing and live PDF preview. Please resize your browser window or switch to a desktop screen.",
  ...
  zh: {
    ...
    themeVividLime: "极速耀绿",
    barrierTitle: "屏幕宽度不足",
    barrierDescription: "此简历编辑器需要至少 1125 像素的屏幕宽度以进行双栏实时编辑与 PDF 预览。请放大浏览器窗口，或切换至更宽的设备。",
  ...
  fr: {
    ...
    barrierTitle: "Largeur d'Écran Trop Étroite",
    barrierDescription: "Cet éditeur requiert une largeur d'écran minimale de 1125px pour l'édition double-panneau et la prévisualisation PDF. Veuillez agrandir votre fenêtre ou utiliser un écran plus large.",
  ...
  de: {
    ...
    barrierTitle: "Bildschirmbreite zu gering",
    barrierDescription: "Dieser Editor erfordert eine Bildschirmbreite von mindestens 1125px für die zweiseitige Bearbeitung und PDF-Vorschau. Bitte vergrößern Sie Ihr Browserfenster.",
  ...
  it: {
    ...
    barrierTitle: "Larghezza dello Schermo Insufficiente",
    barrierDescription: "Questo editor richiede una larghezza minima dello schermo di 1125px per consentire la modifica a due pannelli e l'anteprima PDF. Ridimensiona la finestra del browser.",
  ...
  es: {
    ...
    barrierTitle: "Ancho de Pantalla Insuficiente",
    barrierDescription: "Este editor requiere un ancho mínimo de pantalla de 1125px para permitir la edición en paralelo y la vista previa del PDF. Amplía la ventana del navegador.",
  ...
  pt: {
    ...
    themeVividLime: "Verde Lima Vivo",
    barrierTitle: "Largura de Tela Insuficiente",
    barrierDescription: "Este editor exige uma largura mínima de tela de 1125px para edição em duas colunas e visualização de PDF. Dimensione a janela do navegador.",
  ...
  ja: {
    ...
    barrierTitle: "画面幅が狭すぎます",
    barrierDescription: "この履歴書エディタは、2カラムでの編集とPDFプレビューのため、1125px以上の画面幅が必要です。ブラウザの幅を広げるか、広い画面でご利用ください。",
  ...
  ko: {
    ...
    barrierTitle: "화면 너비가 너무 좁습니다",
    barrierDescription: "이 이력서 편집기는 2단 편집 및 실시간 PDF 미리보기를 위해 최소 1125px의 너비가 필요합니다. 브라우저 창 크기를 키우거나 더 넓은 화면을 사용해 주세요.",
  ...
  ru: {
    ...
    barrierTitle: "Ширина экрана слишком мала",
    barrierDescription: "Для двухпанельного редактирования и предпросмотра PDF требуется ширина экрана не менее 1125px. Пожалуйста, разверните окно браузера или используйте монитор шире.",
  ...
  "zh-tw": {
    ...
    themeVividLime: "極速耀綠",
    barrierTitle: "螢幕寬度不足",
    barrierDescription: "此履歷編輯器需要至少 1125 螢幕寬度以進行雙欄即時編輯與 PDF 預覽。請放大瀏覽器視窗，或切換至更寬的設備。",
  ...
  uk: {
    ...
    barrierTitle: "Ширина екрана занадто мала",
    barrierDescription: "Для двопанельного редагування та попереднього перегляду PDF потрібна ширина екрана щонайменше 1125px. Будь ласка, збільште вікно браузера або використовуйте ширший монітор.",
